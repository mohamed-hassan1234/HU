...
const adminLinks = [
  ...
  { section: 'Academic Calendar', label: 'Academic Years', to: '/admin/academic-years', icon: ClipboardList },
  { section: 'Academic Calendar', label: 'Academic Terms', to: '/admin/academic-terms', icon: ClipboardList },
  { section: 'Academic Calendar', label: 'Operations', to: '/admin/academic-operations', icon: ClipboardPenLine },
